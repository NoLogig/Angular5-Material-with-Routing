...
import { ParticleSpiratRayComponent } from './particle-spiral-ray.component';
    ...
    RouterModule.forRoot([
      {
        ...
        component: ParticleSpiratRayComponent
      }
    ])
  ],
  exports: [ ParticleSpiratRayComponent ],
  declarations: [
    ParticleSpiratRayComponent
  ]
})
export class ParticleSpiratRayModule { }
