...
@Component({
  selector: 'nlg-sound-waves',
  templateUrl: './sound-waves.component.html',
  styleUrls: ['./sound-waves.component.scss']
})
export class SoundWavesComponent implements OnInit {

  metas = {
    title: 'Audio - TrapNation Syntherziser',
    subTitle: 'Use Web-Audio-API & Canvas As An Sytheziser:',
    subExtra: 'Math, Canvas, Audio, FileReader',
    links: {
  ...
  initVisuals() {
    ...
    */
    ...
    var media = [
      "./assets/new_year_dubstep_minimix.ogv"
    ],
      fftSize = 1024,
    ...
    function initialize() {
      ...
      c = document.getElementById('waves') as HTMLCanvasElement;
      ctx = c.getContext('2d');
